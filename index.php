    ...
    <div class="bg-white-0">
        ...
        <section class="hero" id="home" style="background-image: url('./assets/images/hero-bg.jpg')">
            <div class="container" data-aos="fade-up-left">
                ...
                <div class="hero-content">
                    <p class="hero-subtitle">Mangan Restaurant</p>
                    <h2 class="h1 hero-title" style="font-weight:bold;">Feast the Deliciousness!</h2>
                    <p class="hero-text">Ora mangan, perut ora smile</p>
                    <?php if (!isset($_SESSION['user_id'])) { ?>
                        <button class="btn" onclick="window.location.href='register.php'">Order Now</button>
                    <?php } else { ?>
                        <button class="btn"><a href="#food-category">Order Now</a></button>
                    <?php } ?>
                </div>
                ...
                <figure class="hero-banner">
                    ...
                    <img src="./assets/images/ayam.png" width="700" height="637" loading="lazy" alt="ayam" class="w-100 hero-img">
                </figure>

            </div>
        </section>

        <section class="section section-divider white promo" id="food-category">
                ...
                <ul class="promo-list has-scrollbar">
                    <li class="promo-item">
                        <a href="#food-menu">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Appetizer</h3>
                                <p class="card-text">
                                    Excite your palate with our flavorful appetizers! A delightful blend of fresh ingredients and enticing spices, designed to awaken your taste buds. The perfect start to a memorable dining experience.
                                    <img src="./assets/images/promo-1.png" width="300" height="300" loading="lazy" alt="Appetizer" class="w-100 card-banner">
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="promo-item">
                        <a href="#food-menu">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Drinks</h3>

                                <p class="card-text">
                                    Elevate your spirits with our expertly crafted drinks. Our bartenders are artists, ready to create the perfect libation for your palate. From cocktails to wines, find a drink to enhance your dining experience.
                                    <img src="./assets/images/promo-2.png" width="300" height="300" loading="lazy" alt="Drinks" class="w-100 card-banner">
                            </div>
                        </a>
                    </li>

                    <li class="promo-item"><a href="#food-menu">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Main Course</h3>

                                <p class="card-text">
                                    Embark on a culinary journey with our Signature Main Courses. Masterfully crafted with care and precision, each dish is a taste and presentation masterpiece.</p> <br /><br />
                                <img src="./assets/images/promo-3.png" width="300" height="300" loading="lazy" alt="French Fry" class="w-100 card-banner">
                    ...
                    <li class="promo-item"><a href="#food-menu">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Dessert</h3>

                                <p class="card-text">
                                    Indulge in a sweet finale! Our Dessert Collection is a symphony of delectable treats that will sweep you off your feet. Every bite is a sweet celebration. </p><br /><br />
                                <img src="./assets/images/promo-4.png" width="300" height="300" loading="lazy" alt="Dessert" class="w-100 card-banner">
                    ...
                    <li class="promo-item"><a href="#food-menu">
                            <div class="promo-card">
                                ...
                                <p class="card-text">
                                    Elevate snacking with our delectable menu. From crispy fries to savory sliders and mouthwatering nachos, our snacks are perfect for your cravings. Quick bites and satisfying treats await.</p>
                                <img src="./assets/images/promo-5.png" width="300" height="300" loading="lazy" alt="Snacks" class="w-100 card-banner">
                            </div>
                        </a>
                    </li>
        ...
        <section class="section food-menu" id="food-menu">
            <div data-aos="zoom-in" class="container">
                ...
                <p class="section-subtitle">Out Best Dishes</p>
                ...
                <p class="section-text">
                    Our best dishes are a culinary masterpiece, carefully crafted to tantalize your taste buds. Join us for a dining adventure you won't forget.
                </p>
                <ul class="fiter-list">
                    <li>
                        ...
                        <li class="menu-item" data-category="<?= $row['jenismenu'] ?>">
                            <div class="food-menu-card">
                                <div class="card-banner">
                                    ...
                                    <?php if (!isset($_SESSION['user_id'])) { ?>
                                        <button class="btn food-menu-btn" onclick="window.location.href='register.php'">Order Now</button>
                                    <?php } else { ?>
                                        <button class="btn food-menu-btn" onclick="window.location.href='order_process.php?menu_id=<?= $row['idmenu'] ?>&harga=<?= $row['harga'] ?>'">Order Now</button>
                                    <?php } ?>
                                </div>
                                <div class="wrapper">
